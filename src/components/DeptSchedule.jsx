    ...
    <div
      ...
      <div className="flex items-center">
        ...
        <div className="flex p-1 gap-4 bg-gray-100 rounded-lg ml-5 h-10">
          <button className="py-1 px-4 rounded-lg text-xs">Annual</button>
          <button className="py-1 px-4 rounded-lg text-xs bg-white">
            Monthly
          </button>
        </div>
          ...
          : interestTable.map((value, index) => (
            ...
            <span>
              ...
              {value?.interest}
                ...
                <span className=" ml-[15%] text-xs text-teal-500">1.23%</span>
              </td>
              <td>
                <sup>$</sup>
